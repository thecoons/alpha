				...
				<div class="col-xs-12 col-sm-12 col-lg-8 icons">
					...
					<div class="row">
						...
						<div class="col-6 col-sm-4 col-lg-4">    
							<div class="thumbnail">
								<div class="onglet">
									<img class="img-responsive img-index" src="index_fichiers/image/patient1.jpg" alt="patient"> 
						...
						<div class="col-6 col-sm-4 col-lg-4">    
							<div class="thumbnail">
								<div class="onglet">
									<img class="img-responsive img-index" src="index_fichiers/image/agenda.jpg" alt="agenda"> 
						...
						<div class="col-6 col-sm-4 col-lg-4">    
							<div class="thumbnail">
								<div class="onglet">
									<img class="img-responsive img-index" src="index_fichiers/image/montre.jpg" alt="montre"> 
					...
					<div class="row"> 			
						<div class="col-6 col-sm-4 col-lg-4">    
							<div class="thumbnail">
								<div class="onglet">
									<img class="img-responsive img-index" src="index_fichiers/image/botin.jpg" alt="caducée"> 
					...
					<div class="col-6 col-sm-4 col-lg-4">    
							<div class="thumbnail">
								<div class="onglet">
									<img class="img-responsive img-index" src="index_fichiers/image/caisse-enregistreuse.jpg" alt="caisse-enregistreuse"> 
			            ...
			            <div class="col-6 col-sm-4 col-lg-4">    
							<div class="thumbnail">
								<div class="onglet">
									<img class="img-responsive img-index" src="index_fichiers/image/comptabilite.jpg" alt="montre"> 
